...
-- quizzes 8件 / items 435件 (chikei=25, chizu-kigou=22, kencho=47, nihon-chiri=107, rekishi=114, sekai-isan=26, todofuken=47, todofuken-chizu=47)
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'dajodaijin-kiyomori', '平清盛', '平清盛', '中世', '{"hint":"1167年に武士として初めて太政大臣となり、日宋貿易を進めた人物","year":1167,"person":"平清盛","achievement":"武士として初めて太政大臣となり、兵庫の港を整えて日宋貿易を行った"}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'seiitaishogun', '源頼朝', '源頼朝', '中世', '{"hint":"1192年に征夷大将軍に任じられ、鎌倉に幕府を開いた人物","year":1192,"person":"源頼朝","achievement":"守護・地頭を置き、鎌倉に幕府を開いた"}');
