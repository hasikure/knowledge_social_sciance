...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'jiin', '寺院', '寺院', '建物・施設', '{"hint":"仏教に由来する印をかたどっている","accept":["寺","お寺"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'shochugakko', '小・中学校', '小・中学校', '建物・施設', '{"hint":"「文」の字をかたどっている","accept":["小中学校","小学校・中学校","小学校","中学校"]}');
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'kotogakko', '高等学校', '高等学校', '建物・施設', '{"hint":"「文」の字を丸で囲んでいる","accept":["高校"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'kojo', '工場', '工場', '建物・施設', '{"hint":"機械の歯車をかたどっている。2013年の改訂で廃止され、今の地形図には使われていない"}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'kuwabatake', '桑畑', '桑畑', '土地利用', '{"hint":"桑の木の枝ぶりをかたどっている。2013年の改訂で廃止され、今の地形図には使われていない"}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'jushichijo', '十七条の憲法', '十七条の憲法', '古代', '{"hint":"604年、役人の心構えを示すために定められたきまり","year":604,"person":"聖徳太子","achievement":"十七条の憲法や冠位十二階を定め、天皇中心の政治を目指した","accept":["十七条憲法"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'todaiji', '東大寺の大仏', '東大寺の大仏', '古代', '{"hint":"752年に開眼供養が行われた、仏教の力で国を守ろうとしてつくられた大仏","year":752,"person":"聖武天皇","achievement":"仏教の力で国を守ろうと、国分寺と東大寺の大仏をつくらせた","accept":["大仏","奈良の大仏","盧舎那仏"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'kentoshi-teishi', '遣唐使の停止', '遣唐使の停止', '古代', '{"hint":"894年、唐のおとろえと航海の危険を理由に取りやめられた","year":894,"person":"菅原道真","achievement":"894年、遣唐使の停止を提案した","accept":["遣唐使の廃止","遣唐使廃止","遣唐使停止","遣唐使の中止"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'hokusai', '富嶽三十六景', '富嶽三十六景', '近世', '{"hint":"葛飾北斎がえがいた、さまざまな場所からの富士山の風景画集","person":"葛飾北斎","achievement":"『富嶽三十六景』をえがき、風景版画で人気を集めた","accept":["富岳三十六景"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'inou', '大日本沿海輿地全図', '大日本沿海輿地全図', '近世', '{"hint":"全国を測量してつくられた、日本で初めての正確な日本地図。1821年に完成した","year":1821,"person":"伊能忠敬","achievement":"全国を歩いて測量し、正確な日本地図のもとをつくった","accept":["伊能図"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'ryojisaibanken', '領事裁判権の撤廃', '領事裁判権の撤廃', '近代', '{"hint":"1894年、外務大臣がイギリスとの条約改正で実現した。不平等条約の改正が大きく前進した","year":1894,"person":"陸奥宗光","achievement":"1894年に領事裁判権の撤廃に成功した","accept":["治外法権の撤廃","治外法権撤廃","領事裁判権撤廃","領事裁判権の廃止","治外法権の廃止"]}');
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'kanzei', '関税自主権の回復', '関税自主権の回復', '近代', '{"hint":"1911年、外務大臣が実現し、条約改正が完全に達成された","year":1911,"person":"小村寿太郎","achievement":"1911年に関税自主権の回復を実現し、条約改正を完成させた","accept":["関税自主権回復","関税自主権の完全回復"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'so-mura', '惣', '惣', '中世', '{"hint":"室町時代、農民が寄合を開いて村のきまりを定めた自治組織","accept":["惣村"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'tsuchiikki', '土一揆', '土一揆', '中世', '{"hint":"室町時代、農民が借金の帳消し(徳政)を求めて起こした一揆","accept":["徳政一揆"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'daisen', '大仙古墳', '大仙古墳', '原始', '{"hint":"大阪府堺市にある日本最大の前方後円墳。仁徳天皇の墓と伝えられる","accept":["大仙陵古墳","仁徳天皇陵古墳","仁徳天皇陵","大山古墳"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'yamato', '大和政権', '大和政権', '原始', '{"hint":"3世紀後半ごろ、奈良盆地を中心とする豪族たちが大王を中心につくった連合政権","accept":["大和朝廷","ヤマト政権","ヤマト王権","大和王権"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'shorui', '生類憐みの令', '生類憐みの令', '近世', '{"hint":"徳川綱吉が出した、犬をはじめ生き物を大切にすることを命じた極端な法令","person":"徳川綱吉","achievement":"生類憐みの令を出し、学問を重んじる政治を行った","accept":["生類憐れみの令","生類あわれみの令"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'oshio', '大塩平八郎の乱', '大塩平八郎の乱', '近世', '{"hint":"1837年、ききんに苦しむ人々を救おうと、もと幕府の役人が大阪で起こした反乱","year":1837,"accept":["大塩の乱"]}');
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'uchiharai', '異国船打払令', '異国船打払令', '近世', '{"hint":"1825年、日本に近づく外国船を追い払うことを命じた幕府の法令","year":1825,"accept":["外国船打払令","無二念打払令"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'manufacture', '工場制手工業', '工場制手工業', '近世', '{"hint":"作業場に人を集め、分業によって製品をつくる仕組み。マニュファクチュアともいう","accept":["マニュファクチュア"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'seitonaikaku', '政党内閣', '政党内閣', '近代', '{"hint":"1918年、原敬が首相となって成立した、日本で初めての本格的なもの","year":1918,"person":"原敬","achievement":"1918年に日本初の本格的な政党内閣を組織し、「平民宰相」と呼ばれた","accept":["本格的な政党内閣","原敬内閣"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('rekishi', 'renmei-dattai', '国際連盟からの脱退', '国際連盟からの脱退', '近代', '{"hint":"1933年、満州国を認められなかった日本が通告した","year":1933,"accept":["国際連盟脱退","連盟脱退"]}');
...
INSERT INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('sekai-isan', '奄美大島、徳之島、沖縄島北部及び西表島', '奄美大島、徳之島、沖縄島北部及び西表島', '奄美大島、徳之島、沖縄島北部及び西表島', '自然遺産', '{"hint":"アマミノクロウサギやヤンバルクイナなど、固有種の宝庫となっている島々","prefectures":["鹿児島県","沖縄県"],"year":2021,"accept":["奄美・沖縄","奄美大島と沖縄島","奄美大島"]}');
