-- 0012: 地図記号の修正と追加
--
-- 国土地理院の記号一覧(地図記号参照.pdf)と突き合わせ、形の誤りを直した。
-- 警察署・交番・郵便局・高等学校・神社・消防署・老人ホーム・灯台・重要港・
-- 桑畑・広葉樹林・針葉樹林・茶畑・税務署・保健所 など。
-- 「文」は書体で払いが曲線になるため直線で描き直し、田・畑・茶畑・荒地は
-- 実際の地形図と同じく単位記号を3つ三角形に並べる形にした。
--
-- 追加: 裁判所・税務署・保健所・病院・記念碑・墓地・果樹園・田・畑・荒地・発電所 の11問。
-- 病院は旧陸軍衛生隊の五角形＋赤十字、墓地は墓を横から見た形(出典を確認)。
-- 港は「重要港」に統一した。
--
-- 適用: npx wrangler d1 execute chishiki-quiz-db --remote --file=./migrations/0012_chizu_kigou_fix.sql
-- 冪等: UPDATE と INSERT OR IGNORE のみ。
...
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '神社', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'jinja';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '寺院', category = '建物・施設', extra_json = '{"accept":["寺","お寺"]}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'jiin';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '郵便局', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'yubinkyoku';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '小・中学校', category = '建物・施設', extra_json = '{"accept":["小中学校","小学校・中学校","小学校","中学校"]}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'shochugakko';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '高等学校', category = '建物・施設', extra_json = '{"accept":["高校"]}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'kotogakko';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '市役所', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'shiyakusho';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '町村役場', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'choson-yakuba';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '交番', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'koban';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '警察署', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'keisatsusho';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '消防署', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'shobosho';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '工場', category = '建物・施設', extra_json = '{"note":"2013年の改訂で廃止され、今の地形図には使われていない"}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'kojo';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '図書館', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'toshokan';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '博物館', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'hakubutsukan';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '老人ホーム', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'rojin-home';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '灯台', category = '建物・施設', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'todai';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '重要港', category = '建物・施設', extra_json = '{"accept":["港","港湾"]}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'minato';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '温泉', category = '自然・その他', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'onsen';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '三角点', category = '自然・その他', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'sankakuten';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '茶畑', category = '土地利用', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'chabatake';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '桑畑', category = '土地利用', extra_json = '{"note":"2013年の改訂で廃止され、今の地形図には使われていない"}' WHERE quiz_id = 'chizu-kigou' AND item_key = 'kuwabatake';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '広葉樹林', category = '土地利用', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'koyojurin';
UPDATE items SET label = '次の地図記号は何を表しているか。', answer = '針葉樹林', category = '土地利用', extra_json = NULL WHERE quiz_id = 'chizu-kigou' AND item_key = 'shinyojurin';
...
「魏に使いを送り、「親魏倭王」の称号と金印を授けられた」', answer = '卑弥呼', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'himiko-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「十七条の憲法」は西暦何年のことか。数字で答えなさい。', answer = '604', category = '古代', extra_json = '{"accept":["604年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'jushichijo-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「十七条の憲法や冠位十二階を定め、天皇中心の政治を目指した」', answer = '聖徳太子', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'jushichijo-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「冠位十二階」は西暦何年のことか。数字で答えなさい。', answer = '603', category = '古代', extra_json = '{"accept":["603年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kaniijunikai-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「607年、小野妹子らが中国の進んだ制度や文化を学ぶために派遣された使節」', answer = '遣隋使', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenzuishi';
UPDATE items SET label = '「遣隋使」は西暦何年のことか。数字で答えなさい。', answer = '607', category = '古代', extra_json = '{"accept":["607年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kenzuishi-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「607年、遣隋使として隋にわたった」', answer = '小野妹子', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenzuishi-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「645年、蘇我氏を倒して始まった、天皇中心の国づくりを目指す政治改革」', answer = '大化の改新', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taika';
UPDATE items SET label = '「大化の改新」は西暦何年のことか。数字で答えなさい。', answer = '645', category = '古代', extra_json = '{"accept":["645年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'taika-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「中臣鎌足とともに蘇我氏を倒し、大化の改新を進めた」', answer = '中大兄皇子', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taika-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「701年に完成した、律と令からなる国の基本法典」', answer = '大宝律令', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taihoritsuryo';
UPDATE items SET label = '「大宝律令」は西暦何年のことか。数字で答えなさい。', answer = '701', category = '古代', extra_json = '{"accept":["701年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'taihoritsuryo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「710年に奈良につくられた、唐の長安にならった都」', answer = '平城京', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'heijokyo';
UPDATE items SET label = '「平城京」は西暦何年のことか。数字で答えなさい。', answer = '710', category = '古代', extra_json = '{"accept":["710年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'heijokyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「墾田永年私財法」は西暦何年のことか。数字で答えなさい。', answer = '743', category = '古代', extra_json = '{"accept":["743年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'konden-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「東大寺の大仏」は西暦何年のことか。数字で答えなさい。', answer = '752', category = '古代', extra_json = '{"accept":["752年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'todaiji-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「仏教の力で国を守ろうと、国分寺と東大寺の大仏をつくらせた」', answer = '聖武天皇', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'todaiji-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「794年に京都につくられ、以後約400年にわたって都となった」', answer = '平安京', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'heiankyo';
UPDATE items SET label = '「平安京」は西暦何年のことか。数字で答えなさい。', answer = '794', category = '古代', extra_json = '{"accept":["794年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'heiankyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「遣唐使の停止」は西暦何年のことか。数字で答えなさい。', answer = '894', category = '古代', extra_json = '{"accept":["894年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kentoshi-teishi-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「894年、遣唐使の停止を提案した」', answer = '菅原道真', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kentoshi-teishi-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「藤原氏が娘を天皇のきさきにし、摂政・関白として実権をにぎった政治」', answer = '摂関政治', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sekkan';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「4人の娘を天皇のきさきにし、摂関政治の全盛期を築いた」', answer = '藤原道長', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sekkan-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1053年、藤原頼通が宇治に建てた阿弥陀堂。浄土信仰を代表する建物」', answer = '平等院鳳凰堂', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'byodoin';
UPDATE items SET label = '「平等院鳳凰堂」は西暦何年のことか。数字で答えなさい。', answer = '1053', category = '古代', extra_json = '{"accept":["1053年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'byodoin-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「宇治に平等院鳳凰堂を建てた」', answer = '藤原頼通', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'byodoin-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「武士として初めて太政大臣となり、兵庫の港を整えて日宋貿易を行った」', answer = '平清盛', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'dajodaijin-kiyomori-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1185年、現在の山口県で平氏がほろんだ戦い」', answer = '壇ノ浦の戦い', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'dannoura';
UPDATE items SET label = '「壇ノ浦の戦い」は西暦何年のことか。数字で答えなさい。', answer = '1185', category = '中世', extra_json = '{"accept":["1185年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'dannoura-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1192年に征夷大将軍に任じられ、鎌倉に幕府を開いた人物」', answer = '源頼朝', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'seiitaishogun';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「守護・地頭を置き、鎌倉に幕府を開いた」', answer = '源頼朝', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'seiitaishogun-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1221年、後鳥羽上皇が幕府をたおそうとして起こしたが敗れた戦い」', answer = '承久の乱', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'jokyu';
UPDATE items SET label = '「承久の乱」は西暦何年のことか。数字で答えなさい。', answer = '1221', category = '中世', extra_json = '{"accept":["1221年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'jokyu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1232年に定められた、武士の慣習をもとにした初めての武家法」', answer = '御成敗式目', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'goseibai';
UPDATE items SET label = '「御成敗式目」は西暦何年のことか。数字で答えなさい。', answer = '1232', category = '中世', extra_json = '{"accept":["1232年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'goseibai-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「執権として御成敗式目を定めた」', answer = '北条泰時', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'goseibai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1274年、元と高麗の軍が北九州にせめてきた最初の元寇」', answer = '文永の役', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'bunei';
UPDATE items SET label = '「文永の役」は西暦何年のことか。数字で答えなさい。', answer = '1274', category = '中世', extra_json = '{"accept":["1274年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'bunei-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1281年、元が再び北九州にせめてきた二度目の元寇」', answer = '弘安の役', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'koan';
UPDATE items SET label = '「弘安の役」は西暦何年のことか。数字で答えなさい。', answer = '1281', category = '中世', extra_json = '{"accept":["1281年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'koan-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「執権として二度の元寇を退けた」', answer = '北条時宗', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'koan-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「建武の新政」は西暦何年のことか。数字で答えなさい。', answer = '1334', category = '中世', extra_json = '{"accept":["1334年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kenmu-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「鎌倉幕府をたおし、建武の新政を行った」', answer = '後醍醐天皇', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenmu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1338年、足利尊氏が征夷大将軍となって開いた幕府」', answer = '室町幕府', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'muromachi';
UPDATE items SET label = '「室町幕府」は西暦何年のことか。数字で答えなさい。', answer = '1338', category = '中世', extra_json = '{"accept":["1338年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'muromachi-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「征夷大将軍となり、京都に室町幕府を開いた」', answer = '足利尊氏', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'muromachi-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1404年に始まった明との貿易。倭寇と区別するために合い札を用いた」', answer = '勘合貿易', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kango';
UPDATE items SET label = '「勘合貿易」は西暦何年のことか。数字で答えなさい。', answer = '1404', category = '中世', extra_json = '{"accept":["1404年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kango-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「南北朝を統一し、明と勘合貿易を始めた。金閣を建てた」', answer = '足利義満', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kango-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「東山に銀閣を建てた。その後継ぎ争いが応仁の乱の原因となった」', answer = '足利義政', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'ginkaku-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1467年から11年続いた戦乱。京都が荒れ、戦国時代が始まるきっかけとなった」', answer = '応仁の乱', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'onin';
UPDATE items SET label = '「応仁の乱」は西暦何年のことか。数字で答えなさい。', answer = '1467', category = '中世', extra_json = '{"accept":["1467年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'onin-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1543年、種子島に流れ着いたポルトガル人によって伝えられた」', answer = '鉄砲の伝来', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'teppo';
UPDATE items SET label = '「鉄砲の伝来」は西暦何年のことか。数字で答えなさい。', answer = '1543', category = '中世', extra_json = '{"accept":["1543年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'teppo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1549年、鹿児島に上陸した宣教師によって伝えられた」', answer = 'キリスト教の伝来', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kirisutokyo';
UPDATE items SET label = '「キリスト教の伝来」は西暦何年のことか。数字で答えなさい。', answer = '1549', category = '中世', extra_json = '{"accept":["1549年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kirisutokyo-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1549年に鹿児島に来て、日本にキリスト教を伝えた」', answer = 'フランシスコ・ザビエル', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kirisutokyo-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1560年、織田信長が今川義元を破った戦い」', answer = '桶狭間の戦い', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'okehazama';
UPDATE items SET label = '「桶狭間の戦い」は西暦何年のことか。数字で答えなさい。', answer = '1560', category = '近世', extra_json = '{"accept":["1560年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'okehazama-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1575年、織田・徳川の連合軍が鉄砲を大量に使って武田軍を破った戦い」', answer = '長篠の戦い', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nagashino';
UPDATE items SET label = '「長篠の戦い」は西暦何年のことか。数字で答えなさい。', answer = '1575', category = '近世', extra_json = '{"accept":["1575年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nagashino-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「楽市・楽座や関所の廃止を行い、長篠の戦いで鉄砲を活用した」', answer = '織田信長', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nagashino-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1582年、明智光秀にそむかれて織田信長が自害した事件」', answer = '本能寺の変', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'honnoji';
UPDATE items SET label = '「本能寺の変」は西暦何年のことか。数字で答えなさい。', answer = '1582', category = '近世', extra_json = '{"accept":["1582年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'honnoji-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「全国の田畑の面積と収穫高を調べ、年貢を確実に取るために行われた土地の調査」', answer = '太閤検地', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenchi';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「太閤検地と刀狩を行い、兵農分離を進めて全国を統一した」', answer = '豊臣秀吉', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenchi-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1588年、百姓から武器を取り上げ、一揆を防ぐために行われた政策」', answer = '刀狩', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'katanagari';
UPDATE items SET label = '「刀狩」は西暦何年のことか。数字で答えなさい。', answer = '1588', category = '近世', extra_json = '{"accept":["1588年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'katanagari-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1600年、徳川家康が石田三成らを破り、天下の実権をにぎった戦い」', answer = '関ヶ原の戦い', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sekigahara';
UPDATE items SET label = '「関ヶ原の戦い」は西暦何年のことか。数字で答えなさい。', answer = '1600', category = '近世', extra_json = '{"accept":["1600年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sekigahara-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1603年、徳川家康が征夷大将軍となって開いた幕府」', answer = '江戸幕府', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'edobakufu';
UPDATE items SET label = '「江戸幕府」は西暦何年のことか。数字で答えなさい。', answer = '1603', category = '近世', extra_json = '{"accept":["1603年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'edobakufu-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「関ヶ原の戦いに勝ち、江戸に幕府を開いた」', answer = '徳川家康', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'edobakufu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1615年に定められた、大名を統制するためのきまり」', answer = '武家諸法度', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'bukeshohatto';
UPDATE items SET label = '「武家諸法度」は西暦何年のことか。数字で答えなさい。', answer = '1615', category = '近世', extra_json = '{"accept":["1615年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'bukeshohatto-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「参勤交代」は西暦何年のことか。数字で答えなさい。', answer = '1635', category = '近世', extra_json = '{"accept":["1635年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sankinkotai-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「参勤交代を制度化し、鎖国を完成させた」', answer = '徳川家光', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sankinkotai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「島原・天草一揆」は西暦何年のことか。数字で答えなさい。', answer = '1637', category = '近世', extra_json = '{"accept":["1637年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'shimabara-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「鎖国」は西暦何年のことか。数字で答えなさい。', answer = '1641', category = '近世', extra_json = '{"accept":["1641年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sakoku-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1716年から始まった改革。目安箱の設置や公事方御定書の制定を行った」', answer = '享保の改革', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kyoho';
UPDATE items SET label = '「享保の改革」は西暦何年のことか。数字で答えなさい。', answer = '1716', category = '近世', extra_json = '{"accept":["1716年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kyoho-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「享保の改革を行い、目安箱を設置した」', answer = '徳川吉宗', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kyoho-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「寛政の改革」は西暦何年のことか。数字で答えなさい。', answer = '1787', category = '近世', extra_json = '{"accept":["1787年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kansei-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「寛政の改革を行った」', answer = '松平定信', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kansei-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1841年から行われた改革。株仲間の解散などを命じたが、2年余りで失敗した」', answer = '天保の改革', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'tenpo';
UPDATE items SET label = '「天保の改革」は西暦何年のことか。数字で答えなさい。', answer = '1841', category = '近世', extra_json = '{"accept":["1841年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'tenpo-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「天保の改革を行い、株仲間を解散させた」', answer = '水野忠邦', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'tenpo-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「ペリーの来航」は西暦何年のことか。数字で答えなさい。', answer = '1853', category = '近代', extra_json = '{"accept":["1853年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'perry-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1853年に浦賀に来航し、日本に開国を求めた」', answer = 'ペリー', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'perry-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日米和親条約」は西暦何年のことか。数字で答えなさい。', answer = '1854', category = '近代', extra_json = '{"accept":["1854年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'washin-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日米修好通商条約」は西暦何年のことか。数字で答えなさい。', answer = '1858', category = '近代', extra_json = '{"accept":["1858年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'shukotsusho-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1867年、政権を朝廷に返した出来事。江戸幕府が終わった」', answer = '大政奉還', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taiseihokan';
UPDATE items SET label = '「大政奉還」は西暦何年のことか。数字で答えなさい。', answer = '1867', category = '近代', extra_json = '{"accept":["1867年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'taiseihokan-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1867年に大政奉還を行い、政権を朝廷に返した」', answer = '徳川慶喜', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taiseihokan-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1868年、新政府が示した政治の基本方針」', answer = '五箇条の御誓文', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'gokajo';
UPDATE items SET label = '「五箇条の御誓文」は西暦何年のことか。数字で答えなさい。', answer = '1868', category = '近代', extra_json = '{"accept":["1868年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'gokajo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1871年、藩を廃止して県を置き、中央から府知事・県令を派遣した改革」', answer = '廃藩置県', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'haihan';
UPDATE items SET label = '「廃藩置県」は西暦何年のことか。数字で答えなさい。', answer = '1871', category = '近代', extra_json = '{"accept":["1871年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'haihan-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「地租改正」は西暦何年のことか。数字で答えなさい。', answer = '1873', category = '近代', extra_json = '{"accept":["1873年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'chiso-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「大日本帝国憲法」は西暦何年のことか。数字で答えなさい。', answer = '1889', category = '近代', extra_json = '{"accept":["1889年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kenpo-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「初代内閣総理大臣となり、大日本帝国憲法の作成を進めた」', answer = '伊藤博文', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenpo-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1894年に始まった清との戦争。勝利して下関条約で遼東半島や台湾を得た」', answer = '日清戦争', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nisshin';
UPDATE items SET label = '「日清戦争」は西暦何年のことか。数字で答えなさい。', answer = '1894', category = '近代', extra_json = '{"accept":["1894年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nisshin-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日露戦争」は西暦何年のことか。数字で答えなさい。', answer = '1904', category = '近代', extra_json = '{"accept":["1904年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nichiro-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1910年、日本が韓国を植民地とした出来事」', answer = '韓国併合', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kankoku';
UPDATE items SET label = '「韓国併合」は西暦何年のことか。数字で答えなさい。', answer = '1910', category = '近代', extra_json = '{"accept":["1910年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kankoku-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1914年に始まった世界的な戦争。日本は日英同盟を理由に参戦した」', answer = '第一次世界大戦', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'daiichiji';
UPDATE items SET label = '「第一次世界大戦」は西暦何年のことか。数字で答えなさい。', answer = '1914', category = '近代', extra_json = '{"accept":["1914年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'daiichiji-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「満州事変」は西暦何年のことか。数字で答えなさい。', answer = '1931', category = '近代', extra_json = '{"accept":["1931年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'manshu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1937年、北京郊外での衝突をきっかけに始まった中国との戦争」', answer = '日中戦争', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nicchu';
UPDATE items SET label = '「日中戦争」は西暦何年のことか。数字で答えなさい。', answer = '1937', category = '近代', extra_json = '{"accept":["1937年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nicchu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1941年、ハワイの真珠湾への攻撃などによって始まった戦争」', answer = '太平洋戦争', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'taiheiyo';
UPDATE items SET label = '「太平洋戦争」は西暦何年のことか。数字で答えなさい。', answer = '1941', category = '近代', extra_json = '{"accept":["1941年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'taiheiyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1945年に受け入れて日本が降伏することになった、連合国からの宣言」', answer = 'ポツダム宣言', category = '現代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'potsdam';
UPDATE items SET label = '「ポツダム宣言」は西暦何年のことか。数字で答えなさい。', answer = '1945', category = '現代', extra_json = '{"accept":["1945年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'potsdam-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日本国憲法」は西暦何年のことか。数字で答えなさい。', answer = '1946', category = '現代', extra_json = '{"accept":["1946年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nihonkoku-kenpo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「サンフランシスコ平和条約」は西暦何年のことか。数字で答えなさい。', answer = '1951', category = '現代', extra_json = '{"accept":["1951年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sanfrancisco-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1956年、日ソ共同宣言によってソ連の反対がなくなり実現した」', answer = '国際連合への加盟', category = '現代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kokuren';
UPDATE items SET label = '「国際連合への加盟」は西暦何年のことか。数字で答えなさい。', answer = '1956', category = '現代', extra_json = '{"accept":["1956年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kokuren-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「東京オリンピック」は西暦何年のことか。数字で答えなさい。', answer = '1964', category = '現代', extra_json = '{"accept":["1964年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'tokyo-olympic-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1972年、アメリカの統治下から日本に復帰した出来事」', answer = '沖縄の返還', category = '現代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'okinawa';
UPDATE items SET label = '「沖縄の返還」は西暦何年のことか。数字で答えなさい。', answer = '1972', category = '現代', extra_json = '{"accept":["1972年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'okinawa-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「712年にまとめられた、日本最古の歴史書」', answer = '古事記', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kojiki';
UPDATE items SET label = '「古事記」は西暦何年のことか。数字で答えなさい。', answer = '712', category = '古代', extra_json = '{"accept":["712年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kojiki-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「720年にまとめられた、日本の正式な歴史書」', answer = '日本書紀', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nihonshoki';
UPDATE items SET label = '「日本書紀」は西暦何年のことか。数字で答えなさい。', answer = '720', category = '古代', extra_json = '{"accept":["720年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nihonshoki-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「かな文字を用いて長編物語『源氏物語』を書いた」', answer = '紫式部', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'genji-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「「春はあけぼの」で始まる、宮中の生活をつづった随筆」', answer = '枕草子', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'makura';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「宮中の生活を随筆『枕草子』につづった」', answer = '清少納言', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'makura-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「紀貫之らが天皇の命令でまとめた、最初の勅撰和歌集」', answer = '古今和歌集', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kokinshu';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『古今和歌集』をまとめ、かな文字で『土佐日記』を書いた」', answer = '紀貫之', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kokinshu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「唐にわたって天台宗を学び、比叡山に延暦寺を建てた」', answer = '最澄', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'saicho-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「空海が唐から伝え、高野山金剛峯寺を中心に広まった仏教の宗派」', answer = '真言宗', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kukai';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「唐にわたって真言宗を学び、高野山に金剛峯寺を建てた」', answer = '空海', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kukai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「何度も渡航に失敗し、失明しながら来日した唐の僧が奈良に建てた寺」', answer = '唐招提寺', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'ganjin';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「何度も遭難しながら来日し、正しい仏教の戒律を伝えて唐招提寺を建てた」', answer = '鑑真', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'ganjin-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「念仏を唱えれば救われると説き、浄土宗を開いた」', answer = '法然', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'jodoshu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「自分の罪を自覚した悪人こそ救われると説いた、親鸞が開いた宗派」', answer = '浄土真宗', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'jodoshinshu';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「法然の弟子で、浄土真宗を開いた」', answer = '親鸞', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'jodoshinshu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「「南無妙法蓮華経」と題目を唱えることを説いた宗派」', answer = '日蓮宗', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nichirenshu';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「題目を唱えることを説き、日蓮宗を開いた」', answer = '日蓮', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nichirenshu-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「父の観阿弥とともに能を大成した」', answer = '世阿弥', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'noh-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「明にわたって学び、日本の水墨画を大成した」', answer = '雪舟', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'suibokuga-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「質素なわび茶を大成し、茶の湯を芸術の域に高めた」', answer = '千利休', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'wabicha-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『日本永代蔵』などの浮世草子で町人の生活をえがいた」', answer = '井原西鶴', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'ukiyozoshi-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「五・七・五の形式の文芸。松尾芭蕉が芸術性を高めた」', answer = '俳諧', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'haikai';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「各地を旅して『おくのほそ道』を著し、俳諧を芸術に高めた」', answer = '松尾芭蕉', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'haikai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「人形をあやつって物語を演じる芸能。近松門左衛門が脚本を書いた」', answer = '人形浄瑠璃', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'joruri';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『曽根崎心中』などの人形浄瑠璃・歌舞伎の脚本を書いた」', answer = '近松門左衛門', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'joruri-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『富嶽三十六景』をえがき、風景版画で人気を集めた」', answer = '葛飾北斎', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'hokusai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「歌川広重がえがいた、江戸から京都までの宿場の風景画集」', answer = '東海道五十三次', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'hiroshige';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『東海道五十三次』をえがいた」', answer = '歌川広重', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'hiroshige-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「解体新書」は西暦何年のことか。数字で答えなさい。', answer = '1774', category = '近世', extra_json = '{"accept":["1774年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kaitai-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「前野良沢らとオランダ語の解剖書を訳し、『解体新書』を出版した」', answer = '杉田玄白', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kaitai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「仏教や儒教が伝わる前の、日本古来の考え方を明らかにしようとする学問」', answer = '国学', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kokugaku';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『古事記伝』を著し、国学を大成した」', answer = '本居宣長', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kokugaku-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「大日本沿海輿地全図」は西暦何年のことか。数字で答えなさい。', answer = '1821', category = '近世', extra_json = '{"accept":["1821年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'inou-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「全国を歩いて測量し、正確な日本地図のもとをつくった」', answer = '伊能忠敬', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'inou-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「学制」は西暦何年のことか。数字で答えなさい。', answer = '1872', category = '近代', extra_json = '{"accept":["1872年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'gakusei-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「「天は人の上に人を造らず」で始まる、人間の平等と学問の大切さを説いた書物」', answer = '学問のすゝめ', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'gakumon';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「『学問のすゝめ』を著し、欧米の思想を広めた」', answer = '福沢諭吉', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'gakumon-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「民撰議院設立の建白書」は西暦何年のことか。数字で答えなさい。', answer = '1874', category = '近代', extra_json = '{"accept":["1874年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kenpakusho-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「民撰議院設立の建白書を提出し、のちに自由党をつくった」', answer = '板垣退助', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kenpakusho-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1882年に大隈重信がつくった、イギリス流の議会政治を目指した政党」', answer = '立憲改進党', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kaishinto';
UPDATE items SET label = '「立憲改進党」は西暦何年のことか。数字で答えなさい。', answer = '1882', category = '近代', extra_json = '{"accept":["1882年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kaishinto-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「立憲改進党をつくり、のちに早稲田大学のもととなる学校を開いた」', answer = '大隈重信', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kaishinto-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1890年に初めて開かれた議会。衆議院と貴族院の二院制だった」', answer = '帝国議会', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'teikokugikai';
UPDATE items SET label = '「帝国議会」は西暦何年のことか。数字で答えなさい。', answer = '1890', category = '近代', extra_json = '{"accept":["1890年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'teikokugikai-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「領事裁判権の撤廃」は西暦何年のことか。数字で答えなさい。', answer = '1894', category = '近代', extra_json = '{"accept":["1894年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'ryojisaibanken-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1894年に領事裁判権の撤廃に成功した」', answer = '陸奥宗光', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'ryojisaibanken-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「関税自主権の回復」は西暦何年のことか。数字で答えなさい。', answer = '1911', category = '近代', extra_json = '{"accept":["1911年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kanzei-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1911年に関税自主権の回復を実現し、条約改正を完成させた」', answer = '小村寿太郎', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kanzei-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「日清戦争の賠償金をもとに建設され、1901年に操業を始めた官営の製鉄所」', answer = '八幡製鉄所', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'yahata';
UPDATE items SET label = '「八幡製鉄所」は西暦何年のことか。数字で答えなさい。', answer = '1901', category = '近代', extra_json = '{"accept":["1901年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'yahata-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「版籍奉還」は西暦何年のことか。数字で答えなさい。', answer = '1869', category = '近代', extra_json = '{"accept":["1869年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'hanseki-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1873年、満20歳以上の男子に兵役の義務を課した法令」', answer = '徴兵令', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'chohei';
UPDATE items SET label = '「徴兵令」は西暦何年のことか。数字で答えなさい。', answer = '1873', category = '近代', extra_json = '{"accept":["1873年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'chohei-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「西南戦争」は西暦何年のことか。数字で答えなさい。', answer = '1877', category = '近代', extra_json = '{"accept":["1877年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'seinan-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「明治維新に活躍したが、のちに西南戦争で士族に押し立てられて敗れた」', answer = '西郷隆盛', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'seinan-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1895年に結ばれた日清戦争の講和条約。遼東半島や台湾を得た」', answer = '下関条約', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'shimonoseki';
UPDATE items SET label = '「下関条約」は西暦何年のことか。数字で答えなさい。', answer = '1895', category = '近代', extra_json = '{"accept":["1895年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'shimonoseki-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1895年、ロシア・フランス・ドイツが遼東半島の返還を日本にせまった出来事」', answer = '三国干渉', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sangoku';
UPDATE items SET label = '「三国干渉」は西暦何年のことか。数字で答えなさい。', answer = '1895', category = '近代', extra_json = '{"accept":["1895年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sangoku-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「ポーツマス条約」は西暦何年のことか。数字で答えなさい。', answer = '1905', category = '近代', extra_json = '{"accept":["1905年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'portsmouth-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「免罪符を売る教会を批判し、宗教改革を始めた」', answer = 'ルター', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'shukyokaikaku-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1492年に大西洋を横断し、アメリカ大陸付近の島に到達した」', answer = 'コロンブス', category = '中世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'columbus-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「名誉革命」は西暦何年のことか。数字で答えなさい。', answer = '1688', category = '近世', extra_json = '{"accept":["1688年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'meiyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「アメリカ独立宣言」は西暦何年のことか。数字で答えなさい。', answer = '1776', category = '近世', extra_json = '{"accept":["1776年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'dokuritsu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1789年に始まり、自由・平等・国民主権をうたう人権宣言が出された革命」', answer = 'フランス革命', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'furansu';
UPDATE items SET label = '「フランス革命」は西暦何年のことか。数字で答えなさい。', answer = '1789', category = '近世', extra_json = '{"accept":["1789年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'furansu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「アヘン戦争」は西暦何年のことか。数字で答えなさい。', answer = '1840', category = '近代', extra_json = '{"accept":["1840年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'ahen-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1861年に始まったアメリカの内戦。奴隷制をめぐって国内が二分された」', answer = '南北戦争', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nanboku';
UPDATE items SET label = '「南北戦争」は西暦何年のことか。数字で答えなさい。', answer = '1861', category = '近代', extra_json = '{"accept":["1861年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nanboku-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「南北戦争のさなかに奴隷解放宣言を出し、「人民の、人民による、人民のための政治」を説いた」', answer = 'リンカン', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nanboku-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1911年に起こり、清をたおして翌年に中華民国が成立した革命」', answer = '辛亥革命', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'shingai';
UPDATE items SET label = '「辛亥革命」は西暦何年のことか。数字で答えなさい。', answer = '1911', category = '近代', extra_json = '{"accept":["1911年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'shingai-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「三民主義を唱えて辛亥革命を指導し、中華民国の成立に力をつくした」', answer = '孫文', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'shingai-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1917年に起こり、世界で初めての社会主義国が生まれるきっかけとなった革命」', answer = 'ロシア革命', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'roshia';
UPDATE items SET label = '「ロシア革命」は西暦何年のことか。数字で答えなさい。', answer = '1917', category = '近代', extra_json = '{"accept":["1917年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'roshia-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「国際連盟」は西暦何年のことか。数字で答えなさい。', answer = '1920', category = '近代', extra_json = '{"accept":["1920年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kokusairenmei-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1939年、ドイツのポーランド侵攻によって始まった世界的な戦争」', answer = '第二次世界大戦', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'dainiji';
UPDATE items SET label = '「第二次世界大戦」は西暦何年のことか。数字で答えなさい。', answer = '1939', category = '近代', extra_json = '{"accept":["1939年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'dainiji-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「朝鮮戦争」は西暦何年のことか。数字で答えなさい。', answer = '1950', category = '現代', extra_json = '{"accept":["1950年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'chosen-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日ソ共同宣言」は西暦何年のことか。数字で答えなさい。', answer = '1956', category = '現代', extra_json = '{"accept":["1956年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nisso-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「石油危機」は西暦何年のことか。数字で答えなさい。', answer = '1973', category = '現代', extra_json = '{"accept":["1973年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sekiyu-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「壬申の乱」は西暦何年のことか。数字で答えなさい。', answer = '672', category = '古代', extra_json = '{"accept":["672年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'jinshin-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「694年、奈良盆地南部につくられた、日本で初めての本格的な都」', answer = '藤原京', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'fujiwarakyo';
UPDATE items SET label = '「藤原京」は西暦何年のことか。数字で答えなさい。', answer = '694', category = '古代', extra_json = '{"accept":["694年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'fujiwarakyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1086年、白河上皇が始めた、天皇の位をゆずったあとも上皇として政治を動かす仕組み」', answer = '院政', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'insei';
UPDATE items SET label = '「院政」は西暦何年のことか。数字で答えなさい。', answer = '1086', category = '古代', extra_json = '{"accept":["1086年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'insei-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「天皇の位をゆずったあとも上皇として政治を行う院政を始めた」', answer = '白河上皇', category = '古代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'insei-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「保元の乱」は西暦何年のことか。数字で答えなさい。', answer = '1156', category = '古代', extra_json = '{"accept":["1156年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'hogen-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「生類憐みの令を出し、学問を重んじる政治を行った」', answer = '徳川綱吉', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'shorui-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「株仲間を奨励し、商業の力を利用した政治を行ったが、わいろが横行して失脚した」', answer = '田沼意次', category = '近世', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'tanuma-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「大塩平八郎の乱」は西暦何年のことか。数字で答えなさい。', answer = '1837', category = '近世', extra_json = '{"accept":["1837年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'oshio-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「異国船打払令」は西暦何年のことか。数字で答えなさい。', answer = '1825', category = '近世', extra_json = '{"accept":["1825年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'uchiharai-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「日英同盟」は西暦何年のことか。数字で答えなさい。', answer = '1902', category = '近代', extra_json = '{"accept":["1902年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nichiei-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1918年、米の値上がりに対して富山県から全国に広がった民衆の運動」', answer = '米騒動', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kome';
UPDATE items SET label = '「米騒動」は西暦何年のことか。数字で答えなさい。', answer = '1918', category = '近代', extra_json = '{"accept":["1918年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kome-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「政党内閣」は西暦何年のことか。数字で答えなさい。', answer = '1918', category = '近代', extra_json = '{"accept":["1918年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'seitonaikaku-year';
UPDATE items SET label = '次の説明にあてはまる人物はだれか。
「1918年に日本初の本格的な政党内閣を組織し、「平民宰相」と呼ばれた」', answer = '原敬', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'seitonaikaku-person';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「普通選挙法」は西暦何年のことか。数字で答えなさい。', answer = '1925', category = '近代', extra_json = '{"accept":["1925年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'futsusenkyo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1925年、共産主義などの運動を取りしまるために定められた法律」', answer = '治安維持法', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'chian';
UPDATE items SET label = '「治安維持法」は西暦何年のことか。数字で答えなさい。', answer = '1925', category = '近代', extra_json = '{"accept":["1925年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'chian-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1923年、東京や横浜に大きな被害をもたらした地震災害」', answer = '関東大震災', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'kanto-daishinsai';
UPDATE items SET label = '「関東大震災」は西暦何年のことか。数字で答えなさい。', answer = '1923', category = '近代', extra_json = '{"accept":["1923年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'kanto-daishinsai-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1929年、アメリカの株価暴落をきっかけに世界中に広がった不景気」', answer = '世界恐慌', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sekaikyoko';
UPDATE items SET label = '「世界恐慌」は西暦何年のことか。数字で答えなさい。', answer = '1929', category = '近代', extra_json = '{"accept":["1929年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sekaikyoko-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1932年、満州事変のあとに日本が中国東北部につくった国」', answer = '満州国', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'manshukoku';
UPDATE items SET label = '「満州国」は西暦何年のことか。数字で答えなさい。', answer = '1932', category = '近代', extra_json = '{"accept":["1932年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'manshukoku-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「国際連盟からの脱退」は西暦何年のことか。数字で答えなさい。', answer = '1933', category = '近代', extra_json = '{"accept":["1933年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'renmei-dattai-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「五・一五事件」は西暦何年のことか。数字で答えなさい。', answer = '1932', category = '近代', extra_json = '{"accept":["1932年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'goichigo-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「二・二六事件」は西暦何年のことか。数字で答えなさい。', answer = '1936', category = '近代', extra_json = '{"accept":["1936年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'ninirooku-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1938年、戦争のために国民や物資を政府が自由に動かせるようにした法律」', answer = '国家総動員法', category = '近代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'sodoin';
UPDATE items SET label = '「国家総動員法」は西暦何年のことか。数字で答えなさい。', answer = '1938', category = '近代', extra_json = '{"accept":["1938年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'sodoin-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「東海道新幹線」は西暦何年のことか。数字で答えなさい。', answer = '1964', category = '現代', extra_json = '{"accept":["1964年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'shinkansen-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
「1972年、日中共同声明によって中国との国交が結ばれたこと」', answer = '日中国交正常化', category = '現代', extra_json = NULL WHERE quiz_id = 'rekishi' AND item_key = 'nicchu-kokko';
UPDATE items SET label = '「日中国交正常化」は西暦何年のことか。数字で答えなさい。', answer = '1972', category = '現代', extra_json = '{"accept":["1972年"]}' WHERE quiz_id = 'rekishi' AND item_key = 'nicchu-kokko-year';
UPDATE items SET label = '次の説明にあてはまる語句を答えなさい。
...
UPDATE items SET label = '「法隆寺地域の仏教建造物」の所在都道府県を1つ答えなさい。', answer = '奈良県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '法隆寺地域の仏教建造物-pref';
UPDATE items SET label = '「法隆寺地域の仏教建造物」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '法隆寺地域の仏教建造物-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「白鷺城とも呼ばれる、白い外観が美しい天守を持つ城」', answer = '姫路城', category = '文化遺産', extra_json = '{"year":1993}' WHERE quiz_id = 'sekai-isan' AND item_key = '姫路城';
UPDATE items SET label = '「姫路城」の所在都道府県を1つ答えなさい。', answer = '兵庫県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '姫路城-pref';
UPDATE items SET label = '「姫路城」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '姫路城-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「古都京都の文化財」の所在都道府県を1つ答えなさい。', answer = '京都府', category = '文化遺産', extra_json = '{"accept":["滋賀県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '古都京都の文化財-pref';
UPDATE items SET label = '「古都京都の文化財」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '古都京都の文化財-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「白川郷・五箇山の合掌造り集落」の所在都道府県を1つ答えなさい。', answer = '岐阜県', category = '文化遺産', extra_json = '{"accept":["富山県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '白川郷・五箇山の合掌造り集落-pref';
UPDATE items SET label = '「白川郷・五箇山の合掌造り集落」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '白川郷・五箇山の合掌造り集落-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「原子爆弾の惨禍を伝える、骨組みだけが残された建物」', answer = '原爆ドーム', category = '文化遺産', extra_json = '{"year":1996}' WHERE quiz_id = 'sekai-isan' AND item_key = '原爆ドーム';
UPDATE items SET label = '「原爆ドーム」の所在都道府県を1つ答えなさい。', answer = '広島県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '原爆ドーム-pref';
UPDATE items SET label = '「原爆ドーム」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '原爆ドーム-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「海上に立つ朱色の大鳥居で知られる神社」', answer = '厳島神社', category = '文化遺産', extra_json = '{"year":1996}' WHERE quiz_id = 'sekai-isan' AND item_key = '厳島神社';
UPDATE items SET label = '「厳島神社」の所在都道府県を1つ答えなさい。', answer = '広島県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '厳島神社-pref';
UPDATE items SET label = '「厳島神社」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '厳島神社-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「東大寺や興福寺など、かつての都に残る寺社群」', answer = '古都奈良の文化財', category = '文化遺産', extra_json = '{"year":1998}' WHERE quiz_id = 'sekai-isan' AND item_key = '古都奈良の文化財';
UPDATE items SET label = '「古都奈良の文化財」の所在都道府県を1つ答えなさい。', answer = '奈良県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '古都奈良の文化財-pref';
UPDATE items SET label = '「古都奈良の文化財」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '古都奈良の文化財-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「日光の社寺」の所在都道府県を1つ答えなさい。', answer = '栃木県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '日光の社寺-pref';
UPDATE items SET label = '「日光の社寺」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '日光の社寺-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「琉球王国のグスク及び関連遺産群」の所在都道府県を1つ答えなさい。', answer = '沖縄県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '琉球王国のグスク及び関連遺産群-pref';
UPDATE items SET label = '「琉球王国のグスク及び関連遺産群」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '琉球王国のグスク及び関連遺産群-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「紀伊山地の霊場と参詣道」の所在都道府県を1つ答えなさい。', answer = '三重県', category = '文化遺産', extra_json = '{"accept":["奈良県","和歌山県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '紀伊山地の霊場と参詣道-pref';
UPDATE items SET label = '「紀伊山地の霊場と参詣道」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '紀伊山地の霊場と参詣道-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「石見銀山遺跡とその文化的景観」の所在都道府県を1つ答えなさい。', answer = '島根県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '石見銀山遺跡とその文化的景観-pref';
UPDATE items SET label = '「石見銀山遺跡とその文化的景観」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '石見銀山遺跡とその文化的景観-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「中尊寺金色堂など、浄土思想を表す寺院・庭園群」', answer = '平泉', category = '文化遺産', extra_json = '{"year":2011}' WHERE quiz_id = 'sekai-isan' AND item_key = '平泉';
UPDATE items SET label = '「平泉」の所在都道府県を1つ答えなさい。', answer = '岩手県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '平泉-pref';
UPDATE items SET label = '「平泉」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '平泉-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「信仰の対象であり、多くの芸術作品の題材となった日本一の山」', answer = '富士山', category = '文化遺産', extra_json = '{"year":2013}' WHERE quiz_id = 'sekai-isan' AND item_key = '富士山';
UPDATE items SET label = '「富士山」の所在都道府県を1つ答えなさい。', answer = '山梨県', category = '文化遺産', extra_json = '{"accept":["静岡県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '富士山-pref';
UPDATE items SET label = '「富士山」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '富士山-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「富岡製糸場と絹産業遺産群」の所在都道府県を1つ答えなさい。', answer = '群馬県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '富岡製糸場と絹産業遺産群-pref';
UPDATE items SET label = '「富岡製糸場と絹産業遺産群」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '富岡製糸場と絹産業遺産群-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「明治日本の産業革命遺産」の所在都道府県を1つ答えなさい。', answer = '福岡県', category = '文化遺産', extra_json = '{"accept":["佐賀県","長崎県","熊本県","鹿児島県","山口県","岩手県","静岡県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '明治日本の産業革命遺産-pref';
UPDATE items SET label = '「明治日本の産業革命遺産」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '明治日本の産業革命遺産-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「ル・コルビュジエの建築作品」の所在都道府県を1つ答えなさい。', answer = '東京都', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = 'ル・コルビュジエの建築作品-pref';
UPDATE items SET label = '「ル・コルビュジエの建築作品」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = 'ル・コルビュジエの建築作品-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「「神宿る島」宗像・沖ノ島と関連遺産群」の所在都道府県を1つ答えなさい。', answer = '福岡県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '「神宿る島」宗像・沖ノ島と関連遺産群-pref';
UPDATE items SET label = '「「神宿る島」宗像・沖ノ島と関連遺産群」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '「神宿る島」宗像・沖ノ島と関連遺産群-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「長崎と天草地方の潜伏キリシタン関連遺産」の所在都道府県を1つ答えなさい。', answer = '長崎県', category = '文化遺産', extra_json = '{"accept":["熊本県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '長崎と天草地方の潜伏キリシタン関連遺産-pref';
UPDATE items SET label = '「長崎と天草地方の潜伏キリシタン関連遺産」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '長崎と天草地方の潜伏キリシタン関連遺産-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「百舌鳥・古市古墳群」の所在都道府県を1つ答えなさい。', answer = '大阪府', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '百舌鳥・古市古墳群-pref';
UPDATE items SET label = '「百舌鳥・古市古墳群」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '百舌鳥・古市古墳群-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「北海道・北東北の縄文遺跡群」の所在都道府県を1つ答えなさい。', answer = '北海道', category = '文化遺産', extra_json = '{"accept":["青森県","岩手県","秋田県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '北海道・北東北の縄文遺跡群-pref';
UPDATE items SET label = '「北海道・北東北の縄文遺跡群」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '北海道・北東北の縄文遺跡群-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「佐渡島の金山」の所在都道府県を1つ答えなさい。', answer = '新潟県', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '佐渡島の金山-pref';
UPDATE items SET label = '「佐渡島の金山」は文化遺産・自然遺産のどちらに分類される？', answer = '文化遺産', category = '文化遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '佐渡島の金山-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「屋久島」の所在都道府県を1つ答えなさい。', answer = '鹿児島県', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '屋久島-pref';
UPDATE items SET label = '「屋久島」は文化遺産・自然遺産のどちらに分類される？', answer = '自然遺産', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '屋久島-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「世界最大級のブナの原生林が広がる山地」', answer = '白神山地', category = '自然遺産', extra_json = '{"year":1993}' WHERE quiz_id = 'sekai-isan' AND item_key = '白神山地';
UPDATE items SET label = '「白神山地」の所在都道府県を1つ答えなさい。', answer = '青森県', category = '自然遺産', extra_json = '{"accept":["秋田県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '白神山地-pref';
UPDATE items SET label = '「白神山地」は文化遺産・自然遺産のどちらに分類される？', answer = '自然遺産', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '白神山地-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
「流氷が育む豊かな生態系と、ヒグマなど野生動物の宝庫として知られる半島」', answer = '知床', category = '自然遺産', extra_json = '{"year":2005}' WHERE quiz_id = 'sekai-isan' AND item_key = '知床';
UPDATE items SET label = '「知床」の所在都道府県を1つ答えなさい。', answer = '北海道', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '知床-pref';
UPDATE items SET label = '「知床」は文化遺産・自然遺産のどちらに分類される？', answer = '自然遺産', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '知床-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「小笠原諸島」の所在都道府県を1つ答えなさい。', answer = '東京都', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '小笠原諸島-pref';
UPDATE items SET label = '「小笠原諸島」は文化遺産・自然遺産のどちらに分類される？', answer = '自然遺産', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '小笠原諸島-type';
UPDATE items SET label = '次の説明にあてはまる世界遺産は？
...
UPDATE items SET label = '「奄美大島、徳之島、沖縄島北部及び西表島」の所在都道府県を1つ答えなさい。', answer = '鹿児島県', category = '自然遺産', extra_json = '{"accept":["沖縄県"]}' WHERE quiz_id = 'sekai-isan' AND item_key = '奄美大島、徳之島、沖縄島北部及び西表島-pref';
UPDATE items SET label = '「奄美大島、徳之島、沖縄島北部及び西表島」は文化遺産・自然遺産のどちらに分類される？', answer = '自然遺産', category = '自然遺産', extra_json = NULL WHERE quiz_id = 'sekai-isan' AND item_key = '奄美大島、徳之島、沖縄島北部及び西表島-type';
...
-- 分割で増えた 11 件
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'hatsudensho', '次の地図記号は何を表しているか。', '発電所', '建物・施設', '{"accept":["発電所・変電所","変電所"]}');
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'saibansho', '次の地図記号は何を表しているか。', '裁判所', '建物・施設', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'zeimusho', '次の地図記号は何を表しているか。', '税務署', '建物・施設', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'hokenjo', '次の地図記号は何を表しているか。', '保健所', '建物・施設', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'byoin', '次の地図記号は何を表しているか。', '病院', '建物・施設', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'kinenhi', '次の地図記号は何を表しているか。', '記念碑', '建物・施設', '{"accept":["記念広場"]}');
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'bochi', '次の地図記号は何を表しているか。', '墓地', '建物・施設', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'kajuen', '次の地図記号は何を表しているか。', '果樹園', '土地利用', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'ta', '次の地図記号は何を表しているか。', '田', '土地利用', '{"accept":["水田","たんぼ"]}');
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'hatake', '次の地図記号は何を表しているか。', '畑', '土地利用', NULL);
INSERT OR IGNORE INTO items (quiz_id, item_key, label, answer, category, extra_json) VALUES ('chizu-kigou', 'arechi', '次の地図記号は何を表しているか。', '荒地', '土地利用', '{"accept":["荒れ地"]}');
